...
import { applyLoanRequestsRoutes } from 'app/modules/admin/apps/applyLoanRequests/applyLoanRequests.routing';

@NgModule({
  declarations: [InventoryComponent, InventoryListComponent],
  imports: [
    RouterModule.forChild(applyLoanRequestsRoutes),
    MatButtonModule,
    MatCheckboxModule,
    MatFormFieldModule,
    MatIconModule,
...
export class ApplyLoanRequestsModule {}
