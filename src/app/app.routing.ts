...
export const appRoutes: Route[] = [
  ...
  // Admin routes
  {
    ...
    children: [
      ...
      {
        path: 'apply-loan-requests',
        loadChildren: () => import('app/modules/admin/apps/applyLoanRequests/applyLoanRequests.module').then((m) => m.ApplyLoanRequestsModule)
      },
      {
        path: 'loan-requests',
        loadChildren: () => import('app/modules/admin/apps/loanRequests/loanRequests.module').then((m) => m.LoanRequestsModule)
      }
    ]
  }
];
