...
import { brands as brandsData, categories as categoriesData, products as productsData, tags as tagsData, vendors as vendorsData } from 'app/mock-api/apps/banners/inventory/data';

@Injectable({
    providedIn: 'root'
})
export class BannersInventoryMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            .onGet('api/apps/banners/inventory/categories')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/banners/inventory/brands')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/banners/inventory/products', 300)
            .reply(({request}) => {

                // Get available queries
                const search = request.params.get('search');
                const sort = request.params.get('sort') || 'id';
                ...
                // Sort the products
                if ( sort === 'sku' || sort === 'id' || sort === 'active' )
                {
                    products.sort((a, b) => {
                ...
                {
                    // Filter the products
                    products = products.filter(contact => contact.id && contact.id.toLowerCase().includes(search.toLowerCase()));
                }
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/banners/inventory/product')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost('api/apps/banners/inventory/product')
            .reply(() => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/apps/banners/inventory/product')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('api/apps/banners/inventory/product')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/banners/inventory/tags')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost('api/apps/banners/inventory/tag')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/apps/banners/inventory/tag')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('api/apps/banners/inventory/tag')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/banners/inventory/vendors')
