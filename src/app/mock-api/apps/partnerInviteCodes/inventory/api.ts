...
} from 'app/mock-api/apps/partnerInviteCodes/inventory/data';

@Injectable({
  providedIn: 'root'
})
export class PartnersInventoryMockApi {
  ...
  registerHandlers(): void {
    ...
    // @ Categories - GET
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onGet('api/apps/partnerInviteCodes/inventory/categories').reply(() => [200, cloneDeep(this._categories)]);

    // -----------------------------------------------------------------------------------------------------
    // @ Brands - GET
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onGet('api/apps/partnerInviteCodes/inventory/brands').reply(() => [200, cloneDeep(this._brands)]);

    // -----------------------------------------------------------------------------------------------------
    // @ Products - GET
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onGet('api/apps/partnerInviteCodes/inventory/products', 300).reply(({ request }) => {
    ...
    // @ Product - GET
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onGet('api/apps/partnerInviteCodes/inventory/product').reply(({ request }) => {
    ...
    // @ Product - POST
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPost('api/apps/partnerInviteCodes/inventory/product').reply(() => {
      // Generate a new product
      const newProduct = {
        _id: -1,
        name: 'A New Partner Invite Code',
        description: '',
        isActive: false,
        priority: 0,
    ...
    // @ Product - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPatch('api/apps/partnerInviteCodes/inventory/product').reply(({ request }) => {
    ...
    // @ Product - DELETE
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onDelete('api/apps/partnerInviteCodes/inventory/product').reply(({ request }) => {
      // Get the id
      const id = request.params.get('id');
    ...
    // @ Tags - GET
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onGet('api/apps/partnerInviteCodes/inventory/tags').reply(() => [200, cloneDeep(this._tags)]);

    // -----------------------------------------------------------------------------------------------------
    // @ Tags - POST
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPost('api/apps/partnerInviteCodes/inventory/tag').reply(({ request }) => {
      // Get the tag
    ...
    // @ Tags - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPatch('api/apps/partnerInviteCodes/inventory/tag').reply(({ request }) => {
      // Get the id and tag
      const id = request.body.id;
    ...
    // @ Tag - DELETE
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onDelete('api/apps/partnerInviteCodes/inventory/tag').reply(({ request }) => {
      // Get the id
      const id = request.params.get('id');
    ...
    // @ Vendors - GET
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onGet('api/apps/partnerInviteCodes/inventory/vendors').reply(() => [200, cloneDeep(this._vendors)]);
  }
}
